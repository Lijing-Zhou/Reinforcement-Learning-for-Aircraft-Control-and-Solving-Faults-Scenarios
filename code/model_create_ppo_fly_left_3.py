...
model = PPO('MlpPolicy', env, verbose=1,tensorboard_log="./ppo_fly_left1_1_tensorboard/")
model.learn(total_timesteps=int(1e6))
model.save("ppo_fly_left1_1") 
del model 
model = PPO('MlpPolicy', env, verbose=1,tensorboard_log="./ppo_fly_left1_2_tensorboard/")
model.learn(total_timesteps=int(1e6))
model.save("ppo_fly_left1_2") 
del model 
model = PPO('MlpPolicy', env, verbose=1,tensorboard_log="./ppo_fly_left1_3_tensorboard/")
model.learn(total_timesteps=int(1e6))
model.save("ppo_fly_left1_3") 
del model 
