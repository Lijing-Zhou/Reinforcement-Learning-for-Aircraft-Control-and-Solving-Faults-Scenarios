...
def power_up(sim_frequency_hz=100.0, sim_time=10.0):
    ...
    for idx in range(arr_len):
        ...
        #sim.set_controls(t0=1, t1=1, t2=1, t3=1) 
        #sim.set_controls(t0=0.227, t1=0.227, t2=0.227, t3=0.227)
        #sim.set_controls(t0=0.227+0.002, t1=0.227+0.0044, t2=0.227+0.003, t3=0.227+0.005)
        #sim.set_controls(t0=0, t1=0.227, t2=0.227, t3=0.227)
        #sim.set_controls(t0=0.227*math.sin(current_time), t1=0.227, t2=0.227, t3=0.227)
        sim.set_controls(t0=0.227*math.sin(random.uniform(0,6.28)), t1=0.227, t2=0.227, t3=0.227)       
        ...
        #sim.set_controls(t0=0.80, t1=0.80, t2=0.80, t3=0.80)
        #sim.set_controls(t0=0.227, t1=-0.227, t2=0.227, t3=-0.227)
...
if __name__ == '__main__':
    ...
    =power_up(sim_frequency_hz=100.0, sim_time=10.0)
